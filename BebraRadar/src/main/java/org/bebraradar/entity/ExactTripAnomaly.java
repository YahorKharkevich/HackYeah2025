...
@Entity
@Table(name = "exact_trip_anomaly")
public class ExactTripAnomaly {
    ...
    protected ExactTripAnomaly() {
    }

    public ExactTripAnomaly(Trip trip, UserAccount user, OffsetDateTime timestamp, Double latitude, Double longitude,
                            Double gpsAccuracyMeters, String type, Double estimatedDelay) {
        this.trip = trip;
        this.user = user;
