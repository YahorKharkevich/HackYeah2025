...
@Entity
@Table(name = "exact_trip_event_timetable")
public class ExactTripEventTimetable {
    ...
    protected ExactTripEventTimetable() {
    }

    public ExactTripEventTimetable(Trip trip, UserAccount user, OffsetDateTime timestamp, Double latitude,
                                   Double longitude, Double gpsAccuracyMeters, String type, OffsetDateTime reportedTime) {
        this.trip = trip;
        this.user = user;
